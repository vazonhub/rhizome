...
Отдельный workflow для проверки качества кода. Запускается при тех же условиях, что и CI.

**Задачи:**
- **format-check**: Проверка форматирования кода (Black, isort)
- **lint**: Линтинг с flake8
